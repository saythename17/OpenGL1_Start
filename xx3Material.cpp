...
int main() {
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		myShader.setVec3("material.ambient", .0f, .1f, .06f);
		myShader.setVec3("material.diffuse", .0f, .50980392f, .50980392f);
		myShader.setVec3("material.specular", .50196078f, .50196078f, .50196078f);
