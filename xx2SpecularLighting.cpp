...
int main() {
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		lightPosition.x = (float)(1.0f + sin(lastFrame) * 12.0f);
		lightPosition.y = (float)(sin(lastFrame / 2.0f) * 12.0f);
		...
		model = glm::rotate(model, glm::radians(40.0f), glm::vec3(.7f, 0.8f, 0.5f));
